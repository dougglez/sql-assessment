...
var connString = "postgres://dougmaxfield@localhost/assessbox";
...
app.get('/api/vehicles', function(req, res) {
  ...
  app.get('/api/vehicle', function(req, res) {
      if (req.query.userFirstStart) {
          ...
          db.get_vehicle_by_email(req.query.UserEmail, function(err, resp) {
              console.log('req.query.UserEmail', req.query.UserEmail);
